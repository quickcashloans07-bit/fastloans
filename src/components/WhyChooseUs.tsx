        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="animate-fade-in-left">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-primary mb-6 leading-tight"
              ...
              Why Choose <br />
              <span className="text-transparent bg-clip-text" style={{ backgroundImage: "linear-gradient(135deg, hsl(86 56% 51%), hsl(38 92% 50%))" }}>
                Fast Loans
              </span>
            </h2>
            ...
            {reasons.map((reason, index) => (
              <div key={index} 
                ...
                <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-6"
                  ...
                  <reason.icon className="w-6 h-6" style={{ color: "hsl(86 56% 51%)" }} />
                </div>
