...
const testimonials = [  {
    quote: "Fast Loans made the entire process so easy. I was approved in 15 minutes and the funds were in my account the very next morning. It really saved our family vacation!",
