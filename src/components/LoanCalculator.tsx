  ...
  return (
    <section className="py-20 md:py-28 bg-white relative overflow-hidden">
      <div className="absolute top-0 right-0 w-[500px] h-[500px] rounded-full opacity-5 pointer-events-none"
        style={{ background: "radial-gradient(circle, hsl(202 100% 36%), transparent 70%)", transform: "translate(30%, -30%)" }} />
      <div className="absolute bottom-0 left-0 w-[600px] h-[600px] rounded-full opacity-[0.03] pointer-events-none"
        style={{ background: "radial-gradient(circle, hsl(86 56% 51%), transparent 70%)", transform: "translate(-20%, 30%)" }} />

      <div className="max-w-5xl mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6 text-sm font-semibold"
            style={{ background: "hsl(216 68% 22% / 0.05)", color: "hsl(202 100% 36%)", border: "1px solid hsl(216 68% 22% / 0.1)" }}>
            <Calculator className="w-4 h-4" />
            <span className="uppercase tracking-wide">Interactive Tool</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-black mb-4" style={{ fontFamily: "'Poppins', sans-serif", color: "hsl(202 100% 36%)" }}>
            Estimate Your <span className="text-transparent bg-clip-text" style={{ backgroundImage: "linear-gradient(135deg, hsl(86 56% 51%), hsl(38 92% 50%))" }}>Payments</span>
          </h2>
        ...
        <Card className="rounded-3xl border-0 shadow-2xl overflow-hidden" 
          ...
          <div className="grid lg:grid-cols-5 bg-white">
              ...
              <div className="space-y-10">
                ...
                <div>
                   <div className="flex justify-between items-center mb-6">
                     ...
                     <span className="text-3xl font-black" style={{ fontFamily: "'Poppins', sans-serif", color: "hsl(86 56% 51%)" }}>
            ...
            <div className="lg:col-span-2 p-8 md:p-12 text-white relative flex flex-col"
                 style={{ background: "linear-gradient(145deg, hsl(202 100% 36%), hsl(216 68% 15%))" }}>
              ...
              <div className="relative z-10 flex-grow">
                ...
                <div className="space-y-8">
                  <div className="p-6 rounded-2xl relative overflow-hidden" 
                       style={{ background: "linear-gradient(135deg, hsl(202 100% 36%), hsl(202 100% 26%))", boxShadow: "0 10px 30px rgba(0,0,0,0.2)" }}>
