...
const Hero = () => {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="relative overflow-hidden" style={{ background: "linear-gradient(160deg, hsl(202 100% 20%) 0%, hsl(216 68% 20%) 60%, hsl(220 60% 26%) 100%)" }}>
        {/* Animated background circles */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -top-40 -right-40 w-[600px] h-[600px] rounded-full opacity-10"
            style={{ background: "radial-gradient(circle, hsl(86 56% 51%), transparent 70%)" }} />
              ...
              <div className="text-white animate-fade-in">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-black leading-tight mb-6"
                  ...
                  <span className="block" style={{
                    background: "linear-gradient(135deg, hsl(38 92% 50%), hsl(86 56% 51%))",
            ...
            {stats.map((stat, i) => (
              <div key={i} className="py-6 px-8 text-center group hover:bg-emerald-50 transition-colors duration-300">
                <div className="text-3xl font-black mb-1 transition-all"
                  style={{ color: "hsl(202 100% 36%)", fontFamily: "'Poppins', sans-serif" }}>
                  {stat.value}
                </div>
