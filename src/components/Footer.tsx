...
const Footer = () => {
  return (
    <footer className="footer-bg pt-20 pb-10" style={{ background: "hsl(202 100% 20%)", color: "white" }}>
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center gap-2 hover:opacity-90 transition-opacity mb-6 inline-block">
              <div className="bg-white px-3 py-2 rounded-xl inline-block shadow-lg">
                <img src="/logo.png" alt="Fast Loans" className="h-16 w-auto object-contain" />
              </div>
            </Link>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-xs text-white/40 uppercase tracking-wider font-semibold mb-1">Call Us</p>
                  <a href="tel:+12082695420" className="text-white hover:text-accent font-semibold transition-colors">+1 (208)-269-5420</a>
                </div>
              </div>
              <div className="flex items-start gap-3">
              ...
              <div className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-accent mt-0.5 flex-shrink-0" style={{ color: "hsl(86 56% 51%)" }} />
                <div>
                  ...
                  <div className="text-white/80 text-sm space-y-2 mt-1">
                    <div>
                      <span className="font-semibold text-white">HEADQUARTERS ADDRESS:</span><br/>
                      850 W Front St, Boise, ID 83702
                    </div>
                    <div>
                      <span className="font-semibold text-white">BRANCH ADDRESS:</span><br/>
                      850 W Front St, Boise, ID 83702
                    </div>
                  </div>
                </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/get-started" className="text-accent font-semibold hover:text-white transition-colors text-sm pt-2" style={{ color: "hsl(86 56% 51%)" }}>Apply Now →</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-3 p-3 rounded-lg" style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)" }}>
                <Shield className="w-6 h-6" style={{ color: "hsl(86 56% 51%)" }} />
                <span className="text-sm font-semibold text-white/90">256-bit SSL Secure</span>
              </div>
              <div className="flex items-center gap-3 p-3 rounded-lg" style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)" }}>
                <Lock className="w-6 h-6" style={{ color: "hsl(86 56% 51%)" }} />
        ...
        <div className="border-t border-white/10 pt-8 mt-12">
          <div className="text-xs text-white/40 leading-relaxed mb-6 space-y-4">
            ...
            <p>
              Fast Loans does not act as a lender in all instances, but rather as a marketplace to connect borrowers with participating lenders.
            </p>
          </div>
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-white/50 border-t border-white/10 pt-6">
            <p>&copy; {new Date().getFullYear()} Fast Loans. All rights reserved.</p>
