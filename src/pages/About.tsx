  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-grow">
        ...
        {/* Hero Section */}
        <section className="relative overflow-hidden pt-20 pb-32" style={{ background: "hsl(202 100% 20%)" }}>
          {/* Background pattern */}
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <h1 className="text-5xl md:text-7xl font-black text-white mb-6" style={{ fontFamily: "'Poppins', sans-serif" }}>
              About <span className="text-transparent bg-clip-text" style={{ backgroundImage: "linear-gradient(135deg, hsl(86 56% 51%), hsl(38 92% 50%))" }}>Fast Loans</span>
            </h1>
          ...
          <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 md:p-12">
            <div className="grid md:grid-cols-4 gap-8 divide-x-0 md:divide-x divide-gray-100">
              <div className="text-center md:text-left px-4">
                <p className="text-4xl font-black mb-2" style={{ color: "hsl(202 100% 36%)", fontFamily: "'Poppins', sans-serif" }}>15+</p>
                <p className="text-sm font-semibold text-gray-500 uppercase tracking-wider">Years Experience</p>
              </div>
              <div className="text-center md:text-left px-4">
                <p className="text-4xl font-black mb-2" style={{ color: "hsl(202 100% 36%)", fontFamily: "'Poppins', sans-serif" }}>$500M+</p>
                <p className="text-sm font-semibold text-gray-500 uppercase tracking-wider">Loans Funded</p>
              </div>
              <div className="text-center md:text-left px-4">
                <p className="text-4xl font-black mb-2" style={{ color: "hsl(202 100% 36%)", fontFamily: "'Poppins', sans-serif" }}>50k+</p>
                <p className="text-sm font-semibold text-gray-500 uppercase tracking-wider">Happy Clients</p>
              </div>
              <div className="text-center md:text-left px-4">
                <p className="text-4xl font-black mb-2" style={{ color: "hsl(202 100% 36%)", fontFamily: "'Poppins', sans-serif" }}>45min</p>
        ...
        <section className="container mx-auto px-4 py-16 mb-20">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            <h2 className="text-4xl font-black mb-6" style={{ color: "hsl(202 100% 36%)", fontFamily: "'Poppins', sans-serif" }}>
              Our Core Values
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-white p-10 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl transition-shadow text-center">
              <div className="w-16 h-16 mx-auto rounded-2xl flex items-center justify-center mb-6"
                   style={{ background: "linear-gradient(135deg, hsl(202 100% 36%), hsl(202 100% 26%))", color: "white" }}>
        ...
        <section className="bg-white py-24 border-t border-gray-100">
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div>
                <h2 className="text-4xl font-black mb-6" style={{ color: "hsl(202 100% 36%)", fontFamily: "'Poppins', sans-serif" }}>
                  Expertise <span className="text-transparent bg-clip-text" style={{ backgroundImage: "linear-gradient(135deg, hsl(86 56% 51%), hsl(38 92% 50%))" }}>Made Simple</span>
                </h2>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-bold text-lg mb-1" style={{ color: "hsl(202 100% 36%)" }}>Digital Documentation</h3>
                      <p className="text-gray-500">Sign contracts and review documents electronically from any device.</p>
                    </div>
                  </div>
                  
                  <div className="flex items-start gap-4">
                    <div className="mt-1 bg-green-50 p-2 rounded-lg" style={{ color: "hsl(86 56% 51%)" }}>
                      <CreditCard className="w-6 h-6" />
                    </div>
                    <div>
                      <h3 className="font-bold text-lg mb-1" style={{ color: "hsl(202 100% 36%)" }}>Soft Credit Pulls</h3>
                      <p className="text-gray-500">Check your rates without impacting your FICO credit score.</p>
                    </div>
                  </div>
                  
                  <div className="flex items-start gap-4">
                    <div className="mt-1 bg-emerald-50 p-2 rounded-lg" style={{ color: "hsl(86 56% 51%)" }}>
                      <CheckCircle className="w-6 h-6" />
                    </div>
                    <div>
                      <h3 className="font-bold text-lg mb-1" style={{ color: "hsl(202 100% 36%)" }}>Instant Bank Verification</h3>
              ...
              <div className="bg-gray-50 rounded-3xl p-10 border border-gray-100 relative">
                 <div className="absolute top-0 right-0 w-32 h-32 rounded-bl-full" style={{ background: "linear-gradient(135deg, hsl(202 100% 36%), hsl(202 100% 26%))", opacity: 0.1 }}></div>
                 
                 <h3 className="text-2xl font-bold mb-8" style={{ color: "hsl(202 100% 36%)", fontFamily: "'Poppins', sans-serif" }}>Comprehensive Support</h3>
                 
                 <div className="space-y-6">
                    <div className="flex items-center gap-4 bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
                      <MousePointer className="w-6 h-6" style={{ color: "hsl(86 56% 51%)" }} />
                      <span className="font-medium text-gray-700">Online Support 24/7</span>
                    </div>
                    
                    <div className="flex items-center gap-4 bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
                      <Scale className="w-6 h-6" style={{ color: "hsl(86 56% 51%)" }} />
        ...
        <section className="bg-gray-50 py-24 border-t border-gray-100">
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="text-center mb-16 max-w-3xl mx-auto">
              ...
              <p className="text-lg text-gray-500">
                The dedicated professionals behind Fast Loans working to secure your financial future.
              </p>
            </div>
              ...
              {[
                ...
                <div key={i} className="bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100 group hover:-translate-y-2 transition-transform duration-300">
                  ...
                  <div className="p-6 text-center">
                    ...
                    <p className="text-sm font-semibold" style={{ color: "hsl(86 56% 51%)" }}>{member.role}</p>
                  </div>
                </div>
              ))}
            </div>
