        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-12">
            ...
            <div className="text-gray-600 space-y-4 max-w-4xl mx-auto leading-relaxed" style={{ fontSize: "16px" }}>
              ...
              <p>
                I hereby authorize Fast Loans (under reversal credit & reversal process) to access and utilize the following banking information for the specific purpose of processing payments, setting up direct deposits, etc.
              </p>
            </div>
          </div>
      ...
      <footer className="bg-black py-12 mt-auto">
        <div className="container mx-auto px-4">
           <div className="text-center text-white/80" style={{ fontSize: "15px" }}>
             Copyright © 2004-2026, Fast Loans, All Rights Reserved.
           </div>
        </div>
      </footer>
    </div>
