        ...
        <section className="container mx-auto px-4 py-20">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h1 className="text-5xl md:text-6xl font-black mb-6" style={{ fontFamily: "'Poppins', sans-serif", color: "hsl(202 100% 36%)" }}>
                Select Your <span className="text-transparent bg-clip-text" style={{ backgroundImage: "linear-gradient(135deg, hsl(86 56% 51%), hsl(38 92% 50%))" }}>Loan Type</span>
              </h1>
                   ...
                   <div className="space-y-2.5 mb-8">
                     {loan.features.map((feature, i) => (
                       <div key={i} className="flex items-center gap-2">
                         <div className="w-1.5 h-1.5 rounded-full" style={{ background: "hsl(86 56% 51%)" }} />
            ...
            <div className="bg-white border text-center p-10 md:p-14 rounded-3xl shadow-sm relative overflow-hidden">
              ...
              <h2 className="text-3xl font-black mb-10" style={{ fontFamily: "'Poppins', sans-serif", color: "hsl(202 100% 36%)" }}>What to Expect</h2>
              
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
                <div>
                  <div className="w-16 h-16 mx-auto rounded-full flex items-center justify-center text-3xl font-black mb-4" 
                       style={{ background: "hsl(216 68% 22% / 0.05)", color: "hsl(202 100% 36%)", fontFamily: "'Poppins', sans-serif" }}>
                    1
                  </div>
