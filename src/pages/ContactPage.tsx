          ...
          <div className="max-w-6xl mx-auto grid lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 h-full">
                <h3 className="text-xl font-bold mb-8" style={{ color: "hsl(202 100% 36%)", fontFamily: "'Poppins', sans-serif" }}>
                  Contact Information
                </h3>
                ...
                <div className="space-y-8">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+12082695420" className="text-gray-500 hover:text-primary transition-colors block mb-1">+1 (208)-269-5420</a>
                  ...
                  <div className="flex items-start gap-4">
                    <div className="p-3 bg-green-50 rounded-2xl" style={{ color: "hsl(86 56% 51%)" }}>
                      <MapPin className="w-6 h-6" />
                    </div>
                    <div>
                      <h4 className="font-bold text-gray-900 mb-1">BRANCHES:</h4>
                      <p className="text-gray-500 leading-relaxed">
                        <strong className="text-gray-900">HEADQUARTERS ADDRESS:</strong><br/>
                        Block - B, 66 Hutton Centre Dr #330,<br/>
                        Santa Ana, CA 92707<br/><br/>
                        <strong className="text-gray-900">BRANCH ADDRESS:</strong><br/>
            ...
            <div className="lg:col-span-3">
              <div className="bg-white p-8 md:p-12 rounded-3xl shadow-lg border border-gray-100 relative overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-1" 
                     style={{ background: "linear-gradient(90deg, hsl(86 56% 51%), hsl(38 92% 50%))" }} />
                
                <div className="flex items-center gap-3 mb-8">
                  <MessageSquare className="w-6 h-6" style={{ color: "hsl(86 56% 51%)" }} />
